  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center z-50">
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl flex items-center justify-center"
            animate={{
              scale: [1, 1.1, 1],
        ...
        >
          Initializing Professional Music Platform...
        </motion.p>
