...
const { FiEye, FiEyeOff, FiShield, FiZap, FiLock, FiScan, FiCpu, FiWifi, FiMusic, FiCheck, FiArrowRight, FiUser, FiMail, FiX, FiAlertCircle, FiCheckCircle, FiStar, FiCrown } = FiIcons;
      ...
      if (result && result.success) {
        ...
        if (mode === 'register') {
          ...
          if (result.message && result.message.includes('email')) {
            ...
            // Account created and ready - redirect to dashboard
            toast.success(
              `🎉 Welcome to Ovi Network, ${formData.name.split(' ')[0]}! Your creative account is ready. Redirecting you to your dashboard...`,
              {
          ...
          // Enhanced login success - redirect to dashboard
          toast.success(
            `🎵 Welcome back to Ovi Network! Redirecting you to your dashboard...`,
            {
              title: '🌟 Welcome Back!',
              duration: 6000,
              action: {
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
      >
        {/* Enhanced Backdrop with Dynamic Effects */}
        <motion.div
          ...
          style={{
            background: `
              ...
              linear-gradient(135deg, rgba(17,24,39,0.97) 0%, rgba(31,41,55,0.99) 100%)
            `
          }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          style={{
            background: `
              linear-gradient(145deg, rgba(31,41,55,0.98) 0%, rgba(17,24,39,0.99) 100%)
            `,
            ...
            boxShadow: `
              ...
              inset 0 -1px 0 rgba(17,24,39,0.6)
            `
          }}
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row h-full">
            ...
            <motion.div
              ...
              style={{
                background: `
                  linear-gradient(135deg, rgba(17,24,39,0.99) 0%, rgba(31,41,55,0.97) 100%)
                `,
              ...
              <div className="relative z-10">
                ...
                >
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(145deg, rgba(124,58,237,0.9) 0%, rgba(79,70,229,0.7) 100%)',
                      border: '1px solid rgba(124,58,237,0.3)',
                      boxShadow: '0 12px 32px rgba(124,58,237,0.4), inset 0 1px 0 rgba(255,255,255,0.2)'
                    }}
                    animate={{
                      rotate: [0, 360],
                      scale: [1, 1.05, 1]
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-purple-400/20 to-blue-400/20 blur-2xl"
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm font-medium">Revolutionary Music Platform</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-white/80 text-sm leading-relaxed mb-6">
                    Join the world's most advanced music platform with revolutionary authentication,
                    quantum-grade security, AI-powered tools, and professional-grade monetization systems.
                  </p>
                </motion.div>
                ...
                >
                  {[
                    { icon: FiShield, text: 'Military-Grade Security', color: 'text-blue-400', badge: 'SECURE' },
                    { icon: FiZap, text: 'Quantum Authentication', color: 'text-purple-400', badge: 'QUANTUM' },
                    { icon: FiCpu, text: 'AI-Powered Creation Tools', color: 'text-green-400', badge: 'AI' },
                    { icon: FiCrown, text: 'Professional Monetization', color: 'text-yellow-400', badge: 'PRO' }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
                    ...
                    >
                      <div
                        ...
                        style={{
                          background: 'linear-gradient(145deg, rgba(124,58,237,0.15) 0%, rgba(79,70,229,0.25) 100%)',
                          border: '1px solid rgba(124,58,237,0.3)'
                        }}
                      >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center mt-0.5">
                          <span className="text-xs bg-gradient-to-r from-purple-500 to-blue-500 text-white px-2 py-0.5 rounded-full font-bold">
                            {feature.badge}
                          </span>
                        </div>
                      </div>
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-4">
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-white/70 text-sm">
                      {step === 'credentials' ? (mode === 'login' ? 'Sign in to your creative account' : 'Join the music revolution') :
                ...
                {step === 'credentials' && (
                  ...
                  >
                    <motion.button
                      ...
                      style={mode === 'login' ? {
                        background: 'linear-gradient(145deg, rgba(124,58,237,0.9) 0%, rgba(79,70,229,1) 100%)',
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {step === 'email-verification-pending' && (
                      ...
                      >
                        <motion.div
                          className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto"
                          animate={{
                            scale: [1, 1.1, 1],
                            rotate: [0, 10, -10, 0]
                          }}
                        ...
                        <div>
                          ...
                          <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-4 sm:p-5 max-w-md mx-auto">
                    ...
                    {step === 'credentials' && (
                      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6" noValidate>
                        ...
                        {authStatus === 'success' && (
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <SafeIcon icon={FiCheckCircle} className="text-green-400 text-xl" />
                        ...
                        {mode === 'register' && (
                          ...
                          >
                            <label className="block text-white/90 mb-2 text-sm font-medium">
                              <SafeIcon icon={FiUser} className="inline mr-2 text-purple-400" />
                              Full Name
                            </label>
                            <input
                              type="text"
                              ...
                              style={{
                                background: errors.name 
                                  ...
                                  : 'linear-gradient(145deg, rgba(17,24,39,0.9) 0%, rgba(31,41,55,0.7) 100%)',
                        ...
                        <div>
                          <label className="block text-white/90 mb-2 text-sm font-medium">
                            <SafeIcon icon={FiLock} className="inline mr-2 text-green-400" />
                            Password
                          </label>
                          <div className="relative">
                            <input
                              ...
                              className={`w-full py-3 px-4 pr-12 text-white placeholder-white/40 border rounded-2xl transition-all focus:outline-none text-sm ${
                                errors.password 
                                  ? 'border-red-500/50 bg-red-500/5' 
                                  : 'border-white/20 focus:border-green-500/50'
                              }`}
                              style={{
                        ...
                        {mode === 'register' && (
                          ...
                          >
                            <label className="block text-white/90 mb-2 text-sm font-medium">
                              <SafeIcon icon={FiLock} className="inline mr-2 text-yellow-400" />
                              Confirm Password
                            </label>
                            <div className="relative">
                              <input
                                ...
                                className={`w-full py-3 px-4 pr-12 text-white placeholder-white/40 border rounded-2xl transition-all focus:outline-none text-sm ${
                                  errors.confirmPassword 
                                    ? 'border-red-500/50 bg-red-500/5' 
                                    : 'border-white/20 focus:border-yellow-500/50'
                                }`}
                                style={{
                        ...
                        <motion.button
                          ...
                          style={{
                            background: 'linear-gradient(145deg, rgba(124,58,237,0.95) 0%, rgba(79,70,229,1) 100%)',
                            border: '1px solid rgba(124,58,237,0.4)',
                            boxShadow: '0 12px 32px rgba(124,58,237,0.5), inset 0 1px 0 rgba(255,255,255,0.2)'
                          }}
                          whileHover={!isSubmitting && !loading && authStatus !== 'success' ? {
                            scale: 1.02,
                            boxShadow: '0 16px 40px rgba(124,58,237,0.6), inset 0 1px 0 rgba(255,255,255,0.3)'
                          } : {}}
                          whileTap={!isSubmitting && !loading && authStatus !== 'success' ? { scale: 0.98 } : {}}
                        >
                        ...
                        <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 pt-4">
                          <motion.button
                            ...
                            className="text-purple-400 hover:text-purple-300 transition-colors font-medium flex items-center justify-center space-x-2 text-sm"
