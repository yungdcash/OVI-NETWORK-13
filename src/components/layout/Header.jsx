      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center space-x-4 ml-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.button 
              className="p-3 bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 rounded-xl hover:from-purple-500/30 hover:to-blue-500/30 transition-all"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              title="Record"
            >
              <SafeIcon icon={FiMic} className="text-purple-400" />
            </motion.button>
            
            <motion.button 
              className="p-3 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl hover:from-green-500/30 hover:to-emerald-500/30 transition-all"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              title="Monetize"
            >
              <SafeIcon icon={FiDollarSign} className="text-green-400" />
            </motion.button>
          </div>
